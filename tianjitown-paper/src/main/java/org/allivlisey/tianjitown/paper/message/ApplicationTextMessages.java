...
public final class ApplicationTextMessages {
    private ApplicationTextMessages() {
    }

    public static String render(PluginMessages messages, ApplicationText.ValidationIssue issue) {
        Objects.requireNonNull(messages, "messages");
        Objects.requireNonNull(issue, "issue");
        return messages.text(key(issue.code()), issue.parameters());
    }

    public static String join(PluginMessages messages,
    ...
    public static String key(ApplicationText.ValidationIssue.Code code) {
