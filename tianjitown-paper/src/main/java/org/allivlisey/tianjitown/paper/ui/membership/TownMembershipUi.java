...
public final class TownMembershipUi {
    ...
    public record MemberPage(TownPage townPage, UUID memberId) {
    ...
    public record RoleTarget(MemberPage member, MemberRole role) {
    ...
    public record TransferDecision(UUID transferId, boolean accept) {
