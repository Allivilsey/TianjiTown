...
public final class TownFinanceUi {
    private final TownUiLegacyFacade facade;

    public TownFinanceUi(TownUiLegacyFacade facade) {
        this.facade = facade;
    }
    ...
    public void openLedger(Player player, String target) {
        try {
    ...
    public void startDonation(Player player) {
