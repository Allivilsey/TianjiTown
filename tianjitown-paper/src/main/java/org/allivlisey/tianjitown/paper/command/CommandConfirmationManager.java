...
public final class CommandConfirmationManager {
    ...
    public CommandConfirmationManager(Duration ttl, LongSupplier clock, Supplier<String> tokenSupplier) {
    ...
    public record Confirmation(String token, String description, long expiresAt) {
    }

    public record Result(Status status, String description, Runnable action) {
    }
