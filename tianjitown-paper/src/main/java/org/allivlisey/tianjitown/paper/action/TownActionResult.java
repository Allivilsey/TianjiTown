 ...
 */
public record TownActionResult(boolean success, String action, String reason,
                        Map<String, String> data) {
    public TownActionResult {
    ...
    public static TownActionResult success(String action, Map<String, ?> data) {
        return new TownActionResult(true, action, "NONE", stringify(data));
    }

    public static TownActionResult failure(String action, String reason) {
        return new TownActionResult(false, action, reason, Map.of());
    }

    public static TownActionResult failure(String action, String reason, Map<String, ?> data) {
