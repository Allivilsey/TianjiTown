...
final class TownAdminGovernanceCommands {
    private final TownAdminCommand facade;
    private final TianjiTownPlugin plugin;

    TownAdminGovernanceCommands(TownAdminCommand facade, TianjiTownPlugin plugin) {
        this.facade = facade;
        this.plugin = plugin;
    }

    boolean member(CommandSender sender, TownRuntime runtime, String[] args) {
    ...
    boolean vote(CommandSender sender, TownRuntime runtime, String[] args) {
    ...
    boolean mayor(CommandSender sender, TownRuntime runtime, String[] args) {
