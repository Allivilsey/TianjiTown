...
final class TownAdminApplicationUi {
    private final TownUiLegacyFacade facade;

    TownAdminApplicationUi(TownUiLegacyFacade facade) {
        this.facade = facade;
    }
    ...
    void showList(CommandSender sender, List<ApplicationSnapshot> applications) {
    ...
    void notifyDecision(ApplicationSnapshot application) {
    ...
    record RecoveryTarget(TownRepository.RecoveryMode mode, UUID applicationId) {
