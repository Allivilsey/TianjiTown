...
final class TownAdminLandCommands {
    private final TownAdminCommand facade;
    private final TianjiTownPlugin plugin;

    TownAdminLandCommands(TownAdminCommand facade, TianjiTownPlugin plugin) {
        this.facade = facade;
        this.plugin = plugin;
    }

    boolean land(CommandSender sender, TownRuntime runtime, String[] args) {
    ...
    boolean expand(CommandSender sender, TownRuntime runtime, String[] args) {
