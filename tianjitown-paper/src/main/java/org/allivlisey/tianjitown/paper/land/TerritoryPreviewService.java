...
public final class TerritoryPreviewService {
    ...
    public TerritoryPreviewService(TianjiTownPlugin plugin) {
        this.plugin = plugin;
    }

    public void teleportAndPreview(Player player, InitialTerritory territory) {
        teleportAndPreview(player, territory, List.of(territory));
    }

    public void teleportAndPreviewSilently(Player player, InitialTerritory territory) {
        teleportAndPreview(player, territory, List.of(territory), false);
    }

    public void teleportAndPreview(Player player, InitialTerritory focus,
    ...
    public void preview(Player player, InitialTerritory territory) {
        preview(player, List.of(territory));
    }

    public void previewSilently(Player player, InitialTerritory territory) {
        preview(player, List.of(territory), false);
    }

    public void previewSilently(Player player, List<InitialTerritory> territories) {
        preview(player, territories, false);
    }

    public void preview(Player player, List<InitialTerritory> territories) {
    ...
    public static String previewScope(int areaCount,
    ...
    public static List<InitialTerritory> previewAreas(
