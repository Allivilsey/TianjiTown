...
public final class TownAdminEconomyCommands {
    ...
    public boolean money(CommandSender sender, TownRuntime runtime, String[] args) {
    ...
    public boolean tax(CommandSender sender, TownRuntime runtime, String[] args) {
    ...
    public boolean ledger(CommandSender sender, TownRuntime runtime, String[] args) {
    ...
    public boolean buff(CommandSender sender, TownRuntime runtime, String[] args) {
