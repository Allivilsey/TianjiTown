...
public final class TerritoryService {
    ...
    public TerritoryService(EconomyRepository finance, SitePolicy sitePolicy,
    ...
    public ExpansionPreview preview(UUID playerId, ExpansionDirection direction) {
    ...
    public ExpansionPreview preview(UUID playerId, int gridX, int gridZ) {
        Context context = context(playerId);
        requireCapacity(context);
    ...
    public ExpansionBatchPreview batchPreview(UUID playerId, Set<GridSelection> selections) {
        Context context = context(playerId);
    ...
    public TerritoryMap map(UUID playerId) {
        Context context = context(playerId);
    ...
    public TerritoryMap validate(TerritoryMap map) {
    ...
    public SitePolicy.Validation validate(ExpansionPreview preview) {
    ...
    public record ExpansionPreview(EconomyRepository.TownFinance account, TerritoryUnit candidate,
                            String residenceName, String areaName, long priceMinor,
                            int totalUnits) {
    }

    public record GridSelection(int gridX, int gridZ) {
    }

    public record ExpansionBatchPreview(EconomyRepository.TownFinance account,
    ...
    public record TerritoryCell(int gridX, int gridZ, TerritoryCellState state,
                         InitialTerritory territory, ExpansionPreview preview, String detail) {
    }

    public record TerritoryMap(List<TerritoryCell> cells, int currentUnits, int maximumUnits,
                        long priceMinor) {
        public TerritoryMap {
