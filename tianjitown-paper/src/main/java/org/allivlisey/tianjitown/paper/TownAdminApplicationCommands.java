...
final class TownAdminApplicationCommands {
    private final TownAdminCommand facade;
    private final TianjiTownPlugin plugin;

    TownAdminApplicationCommands(TownAdminCommand facade, TianjiTownPlugin plugin) {
        this.facade = facade;
        this.plugin = plugin;
    }

    boolean application(CommandSender sender, TownRuntime runtime, String[] args) {
        if (args.length < 2) {
    ...
    boolean town(CommandSender sender, TownRuntime runtime, String[] args) {
