...
public record JoinTownMenuModel(List<String> summaryLore, Entry rulesEntry, Entry applyEntry) {
    ...
    public static JoinTownMenuModel create(PluginMessages messages, TownSnapshot town) {
    ...
    public record Entry(int slot, String labelKey, List<String> loreKeys, String action, String target) {
