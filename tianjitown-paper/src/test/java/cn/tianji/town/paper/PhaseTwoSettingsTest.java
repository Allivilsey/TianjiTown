...
class PhaseTwoSettingsTest {
    @Test
    void usesSafeDefaultsWhenPhaseTwoConfigurationIsMissing() {
        PhaseTwoSettings settings = PhaseTwoSettings.load(new MemoryConfiguration());
    ...
    @Test
    void rejectsEveryOverflowingPhaseTwoDurationWithConfigurationPath() {
