...
/** Owns connections and SQLite transaction boundaries for economy workflows. */
final class EconomyDatabase {
    private final DataSource dataSource;
    private final BooleanSupplier forbiddenThread;

    EconomyDatabase(DataSource dataSource, BooleanSupplier forbiddenThread) {
