...
import org.allivlisey.tianjitown.storage.town.TownRepository.StorageUnavailableException;

/** Owns connections and SQLite transaction boundaries for town workflows. */
final class TownDatabase {
    private final DataSource dataSource;
    private final BooleanSupplier forbiddenThread;

    TownDatabase(DataSource dataSource, BooleanSupplier forbiddenThread) {
